...
<script>
	$(document).ready(function(){
		...
		if(arDigitalOptions['THEME']['PHONE_MASK'].length){
			...
			$('.popup form[name="<?=$arResult["IBLOCK_CODE"]?>"] input.phone').inputmask('mask', {'mask': arDigitalOptions['THEME']['PHONE_MASK'], 'showMaskOnHover': false });
		...
		if(arDigitalOptions['THEME']['DATE_MASK'].length)
			$('.popup form[name="<?=$arResult["IBLOCK_CODE"]?>"] input.date').inputmask(arDigitalOptions['THEME']['DATE_MASK'], { 'placeholder': arDigitalOptions['THEME']['DATE_PLACEHOLDER'], 'showMaskOnHover': false  });
