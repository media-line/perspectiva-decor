...
class DateConverter
{
	...
	public static function decode($text, $limit = 0)
	{
		...
		$timeOfStartDate = str_pad(\Bitrix\Main\Config\Option::get('calendar', 'work_time_start', '9'), 2, "0", STR_PAD_LEFT).':00';
		$timeOfEndDate = \Bitrix\Main\Config\Option::get('calendar', 'work_time_end', '18').':00';
