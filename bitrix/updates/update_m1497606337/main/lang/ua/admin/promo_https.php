...
$MESS["HTTPS_PROMO__CHANGE_LINKS_NEW"] = "Змінити посилання, які використовуються у проекті, з абсолютних на відносні.";
$MESS["HTTPS_PROMO__CHECK_PROTOCOL_NEW"] = "Перевірити і змінити для контенту (відео, картинки), що завантажується зі сторонніх ресурсів, протокол, за яким проект запитує контент.";
...
$MESS["HTTPS_PROMO__TO_MOST_SITES"] = "– підійде для більшості проектів.";
