		...
		return $popupHtml . '
			...
			<table width="100%" border="0" cellspacing="7" cellpadding="0">
				...
				<tr>
					...
					<td class="adm-detail-content-cell-r" style="width:60%;">
						<textarea name="discount_prediction_text" id="prediction_text" cols="55" rows="1" style="width: 90%; margin-top: 0px; margin-bottom: 0px; height: 50px;">' . $state->get('discount_prediction_text', Loc::getMessage('SALE_HANDLERS_DISCOUNTPRESET_ORDERAMOUNT_ORDER_DISCOUNT_PREDICTION_TEXT_DEFAULT')) . '</textarea>
